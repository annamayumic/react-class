...
export default function TimerChallenge({title, targetTime}){
  ...
  const [timeRemaining, setTimeRemainling] = useState(targetTime*1000)
  ...
  function handleReset(){
    setTimeRemainling(targetTime*1000)
  }


  function handleStart(){
    timer.current = setInterval(()=>{
      setTimeRemainling(prevTimeRemaining => prevTimeRemaining-10);
    }, 10)
  }
